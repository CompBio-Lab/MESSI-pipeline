...
doc <- "This script is to run required preprocessing steps for logit_demo including data transformation
...
Usage:
  logit_demo_preprocess.R [options]
...
main <- function(mae_path, split_dir, dataset_name) {
  ...
  for (fold_name in fold_names) {
    ...
    set.seed(123) # Just for reproducibility issue, since we taking randomly 25 features
