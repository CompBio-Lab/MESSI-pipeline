...
def transform_mudata_format(mu_path, dataset_name, identifier_col="sample_name", var_threshold=0.01, scale=False):
    # Read data here
    ...
    for modality in data.mod:
        ...
        # Remove those of variance under certain threshold
        # Duplicate NA columns since columns represent features
        # And scale each
        df_reduced = preprocess_view(df = omic_df, var_threshold = var_threshold, scale=scale)
