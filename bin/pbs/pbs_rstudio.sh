...
#PBS -l walltime=05:00:00,select=1:ncpus=6:mem=24gb
...
PIPELINE_DIR=${PROJECT_PATH}/multi-omics-pipeline
DATA_PATH=${PIPELINE_DIR}/data
#IMAGE=$PROJECT_PATH/images/mixdiablo.sif
IMAGE=${PIPELINE_DIR}/apptainer_images/codia.sif
# Change here to replace image used
