...
process METHOD_PREPROCESS {
  ...
  input:
    ...
    */
    tuple val(dataset_name), path(mae_or_mu), path(split_dir)
  ...
  script:
    ...
    TODO:
      ...
      - rename the cli arg name like mae_or_mu_path to one of:
        - mae_path
        - mu_path
    */
    """
    preprocess_method.ext \
      --mae_or_mu_path=${mae_or_mu} \
      --split_dir=${split_dir} \
