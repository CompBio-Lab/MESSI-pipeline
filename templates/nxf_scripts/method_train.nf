...
// Handles the METHOD  listed the Reference section of top-level README
/*
...
process METHOD_TRAIN {
	...
	input:
		tuple val(dataset_name), path(mae_or_mu_path), path(fold_path)
	/* 
